...
|[CGALPlugin](https://www.github.com/sofa-framework/CGALPlugin.git)|Plugins offering SOFA bindings to the [CGAL library](https://www.cgal.org/) for meshing purposes. |CMake flags `SOFA_FETCH_CGALPLUGIN=ON` and `PLUGIN_CGALPLUGIN=ON`. |
...
|[Cosserat](https://www.github.com/SofaDefrost/Cosserat.git)|External Plugin named Cosserat that needs to be fetched.|CMake flags `SOFA_FETCH_COSSERAT=ON` and `PLUGIN_COSSERAT=ON`. Activated in presets ['full', 'supported-plugins']. |
...
|[SofaImplicitField](https://www.github.com/sofa-framework/SofaImplicitField.git)|External Plugin named SofaImplicitField that needs to be fetched.|CMake flags `SOFA_FETCH_SOFAIMPLICITFIELD=ON` and `PLUGIN_SOFAIMPLICITFIELD=ON`. Activated in presets ['full', 'supported-plugins']. |
...
|[SofaViscoElastic](https://www.github.com/SofaDefrost/SofaViscoElastic.git)|Plugin implementing the fundamental linear viscoelastic and visco-hyperelastic constitutive laws applied to tetrahedral meshes.
 |CMake flags `SOFA_FETCH_SOFAVISCOELASTIC=ON` and `PLUGIN_SOFAVISCOELASTIC=ON`. |
...
|[SoftRobots.Inverse](https://www.github.com/SofaDefrost/SoftRobots.Inverse.git)|External Plugin named SoftRobots.Inverse that needs to be fetched.|CMake flags `SOFA_FETCH_SOFTROBOTS_INVERSE=ON` and `PLUGIN_SOFTROBOTS_INVERSE=ON`. Activated in presets ['full', 'supported-plugins']. |
