...
|[SofaViscoElastic](https://www.github.com/SofaDefrost/SofaViscoElastic.git)|External Plugin named SofaViscoElastic that needs to be fetched.|CMake flags `SOFA_FETCH_SOFAVISCOELASTIC=ON` and `PLUGIN_SOFAVISCOELASTIC=ON`. Activated in presets ['full', 'supported-plugins']. |
