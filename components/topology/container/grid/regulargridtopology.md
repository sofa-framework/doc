...
=== "Python"
    ...
    def createScene(root_node):
       ...
       required_plugins.addObject('RequiredPlugin', pluginName="Sofa.Component.Topology.Mapping")
       required_plugins.addObject('RequiredPlugin', pluginName="Sofa.Component.Visual")
       required_plugins.addObject('RequiredPlugin', pluginName="Sofa.GL.Component.Rendering3D")
