...
=== "XML"
    ...
    <Node name="root" gravity="0 -9.81 0" dt="0.05">
        ...
        <Node name="plugins">
            ...
            <RequiredPlugin pluginName="Sofa.GL.Component.Rendering2D"/> <!-- Needed to use components [OglColorMap] -->
            <RequiredPlugin pluginName="Sofa.GL.Component.Rendering3D"/> <!-- Needed to use components [DataDisplay OglModel] -->
        </Node>
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       plugins.addObject('RequiredPlugin', pluginName="Sofa.GL.Component.Rendering2D")
