...
=== "XML"
    ...
    <Node name="root" dt="0.05" showBoundingTree="0" gravity="0 -9 0">
        ...
        <RequiredPlugin pluginName="Sofa.Component.Engine.Select"/> <!-- Needed to use components [PlaneROI ProximityROI] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       t.addObject('PlaneROI', plane="0 0 0.9 1. 0 0.9 0 1 1.1 0.2", position="@../Volume.position", drawTriangles="1", drawTetrahedra="1", triangles="@Container.triangles", tetrahedra="@../Container.tetrahedra", name="planeROI")
       t.addObject('TrianglePressureForceField', triangleIndices="@planeROI.triangleIndices", pressure="0.4 0 0")
