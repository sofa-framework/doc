...
=== "XML"
    ...
    <Node name="root" dt="0.02">
        <Node name="requiredPlugins">
            ...
            <RequiredPlugin pluginName="Sofa.Component.Engine.Select"/> <!-- Needed to use components [BoxROI NearestPointROI] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       required_plugins.addObject('RequiredPlugin', pluginName="Sofa.Component.Constraint.Lagrangian.Model")
