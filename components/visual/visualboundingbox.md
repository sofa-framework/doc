...
=== "XML"
    ...
    <Node name="root" dt="0.01">
        ...
        <RequiredPlugin pluginName="Sofa.Component.Visual"/> <!-- Needed to use components [VisualBoundingBox] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       root.addObject('VisualBoundingBox', color="green", thickness="20", bbox="@VisualModel.bbox")
    ```
