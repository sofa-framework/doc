...
=== "XML"
    ...
    <Node name="root" dt="0.001" gravity="0 -9.81 0">
        ...
        <RequiredPlugin pluginName="Sofa.Component.Constraint.Lagrangian.Model"/> <!-- Needed to use components [SlidingLagrangianConstraint] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       root.addObject('BlockGaussSeidelConstraintSolver', maxIterations="1000", tolerance="0.001")
