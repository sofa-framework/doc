...
=== "XML"
    ...
    <Node 	name="root" gravity="0 0 0" dt="0.05"  >
        <RequiredPlugin pluginName="Sofa.Component.Constraint.Projective"/> <!-- Needed to use components [DirectionProjectiveConstraint FixedProjectiveConstraint] -->
        ...
        <RequiredPlugin pluginName="Sofa.Component.Topology.Mapping"/> <!-- Needed to use components [Triangle2EdgeTopologicalMapping] -->
