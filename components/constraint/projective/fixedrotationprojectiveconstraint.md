...
=== "XML"
    ...
    <Node name="Root" gravity="0 -9.81 0" dt="0.02">
        ...
        <RequiredPlugin pluginName="Sofa.Component.Constraint.Projective"/> <!-- Needed to use components [FixedProjectiveConstraint FixedRotationProjectiveConstraint] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       spring.addObject('RigidMapping', template="Rigid3,Rigid3", name="default1", rigidIndexPerPoint="1 1")
...
")
       ...
       spring.addObject('RigidMapping', template="Rigid3,Rigid3", name="default11", rigidIndexPerPoint="1 1")
