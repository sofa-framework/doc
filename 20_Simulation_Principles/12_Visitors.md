...
Examples:
  ...
  - at the level of an [AnimationLoop](../main-principles/animation-loop/), visitors are used for instance to trigger the simulation step (_AnimateVisitor_), update the context (_UpdateSimulationContextVisitor_) and update the mappings (_UpdateMappingVisitor_).
