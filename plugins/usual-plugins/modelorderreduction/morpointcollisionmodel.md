...
Display Collision Model Points free position(in green)
	...
	<tr>
		<td>displayContactModes</td>
		<td>
display Contact Modes
		</td>
		<td>0</td>
	</tr>
	<tr>
		<td>lambdaModesPath</td>
		<td>
path to the file containing the lambda modes
		</td>
		<td></td>
	</tr>
	<tr>
		<td>lambdaModesCoeffsPath</td>
		<td>
path to the file containing the coefficients of lambda modes
		</td>
		<td></td>
	</tr>
