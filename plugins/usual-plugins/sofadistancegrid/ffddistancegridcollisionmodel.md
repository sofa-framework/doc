...
=== "XML"
    ...
    <Node name="root" dt="0.005" gravity="0.0 -9.81 0">
        ...
        <RequiredPlugin pluginName="Sofa.Component.Collision.Geometry"/> <!-- Needed to use components [PointCollisionModel TriangleCollisionModel] -->
        ...
        <RequiredPlugin pluginName="Sofa.Component.Topology.Container.Grid"/> <!-- Needed to use components [RegularGridTopology SparseGridTopology] -->
        ...
        <RequiredPlugin pluginName="SofaDistanceGrid"/> <!-- Needed to use components [FFDDistanceGridCollisionModel] -->
...
=== "Python"
    ...
    def createScene(root_node):
       ...
       root.addObject('RequiredPlugin', pluginName="SofaDistanceGrid")
