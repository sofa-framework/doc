...
Constrain a rigid to be attached to a beam (only in position, not the orientation).
...
|interpolation|link to the WireBeamInterpolation component in the scene|WireBeamInterpolation&lt;Rigid3d&gt;|
