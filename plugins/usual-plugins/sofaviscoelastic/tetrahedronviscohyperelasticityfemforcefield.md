...
__Target__: SofaViscoElastic

__namespace__: sofa::SofaViscoElastic
...
the name of the material to be used
		...
		<td>SLSMooneyRivlinFirstOrder</td>
	</tr>
	<tr>
		<td>ParameterSet</td>
		<td>
...
Internal edge data
	...
	<tr>
		<td>stressSPK</td>
		<td>
The stress of the Second Piola Kirchhoff Stress Tensor per Element
		</td>
		<td></td>
	</tr>
	<tr>
		<td>stressVonMisesElement</td>
		<td>
The stress of the Von Mises Stress per Element
		</td>
		<td></td>
	</tr>
	<tr>
		<td>stressVonMisesNode</td>
		<td>
The stress of the Von Mises Stress per Node
		</td>
		<td></td>
	</tr>
