...
The collision pipelines are executed in an [animation loop](../../../20_Simulation_Principles/11_Animation_Loop.md).
...
A collision pipeline is called from an [animation loop](../../../20_Simulation_Principles/11_Animation_Loop.md) through a [CollisionVisitor](https://www.sofa-framework.org/api/master/sofa/html/classsofa_1_1simulation_1_1_collision_visitor.html) executing the 3 steps of the pipeline in `CollisionVisitor::processCollisionPipeline`.
...
See an example in [_DefaultPipeline_](20_DefaultPipeline.md).
...
- [_DefaultPipeline_](20_DefaultPipeline.md)
