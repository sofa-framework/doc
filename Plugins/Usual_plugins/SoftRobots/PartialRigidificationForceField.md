...
|rigidMapping|link to the rigidMapping that does the rigidification|
|subsetMultiMapping|link to the subsetMultiMapping that unifies rigid and deformable parts|
|mappedForceField|link to the forcefield that is mapped under the subsetMultiMapping|
